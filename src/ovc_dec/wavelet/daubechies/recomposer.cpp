...
daubechies_recomposer::daubechies_recomposer(ovc_wavelet_config in_config)
{
...
matrix<double> daubechies_recomposer::recompose(ovc_wavelet_decomposition_2d<double>& in_decomposition, const matrix_size& in_size_rec) const
{
