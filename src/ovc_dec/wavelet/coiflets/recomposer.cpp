...
coiflets_recomposer::coiflets_recomposer(ovc::wavelet_config in_config)
{
	using namespace ovc;
...
matrix<double> coiflets_recomposer::recompose(ovc::wavelet_decomposition_2d<double>& in_decomposition, const matrix_size& in_size_rec) const
{
