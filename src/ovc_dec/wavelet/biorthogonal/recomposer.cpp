...
biorthogonal_recomposer::biorthogonal_recomposer(ovc::wavelet_config in_config)
{
	using namespace ovc;
...
matrix<double> biorthogonal_recomposer::recompose(ovc::wavelet_decomposition_2d<double>& in_decomposition, const matrix_size& in_size_rec) const
{
