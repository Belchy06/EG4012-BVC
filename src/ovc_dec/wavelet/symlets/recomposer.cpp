#include "ovc_common/wavelet/symlets/symlets.h"
#include "ovc_dec/wavelet/symlets/recomposer.h"

symlets_recomposer::symlets_recomposer(ovc_wavelet_config in_config)
{
...
matrix<double> symlets_recomposer::recompose(ovc_wavelet_decomposition_2d<double>& in_decomposition, const matrix_size& in_size_rec) const
{
