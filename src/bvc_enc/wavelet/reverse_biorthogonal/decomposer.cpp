...
reverse_biorthogonal_decomposer::reverse_biorthogonal_decomposer(bvc_wavelet_config in_config)
{
...
bvc_wavelet_decomposition_2d<double> reverse_biorthogonal_decomposer::decompose(const matrix<double>& in_x, size_t in_num_levels)
{
