...
symlets_recomposer::symlets_recomposer(bvc_wavelet_config in_config)
{
...
matrix<double> symlets_recomposer::recompose(bvc_wavelet_decomposition_2d<double>& in_decomposition, const matrix_size& in_size_rec) const
{
