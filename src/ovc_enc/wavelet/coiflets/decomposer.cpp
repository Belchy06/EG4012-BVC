...
coiflets_decomposer::coiflets_decomposer(ovc_wavelet_config in_config)
{
...
ovc_wavelet_decomposition_2d<double> coiflets_decomposer::decompose(const matrix<double>& in_x, size_t in_num_levels)
{
