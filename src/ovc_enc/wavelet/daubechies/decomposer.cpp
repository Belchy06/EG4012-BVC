...
daubechies_decomposer::daubechies_decomposer(ovc_wavelet_config in_config)
{
...
ovc_wavelet_decomposition_2d<double> daubechies_decomposer::decompose(const matrix<double>& in_x, size_t in_num_levels)
{
