...
std::shared_ptr<wavelet_decomposer> wavelet_decomposer_factory::create_wavelet_decomposer(ovc::wavelet_family in_wavelet_transform, ovc::wavelet_config in_config)
{
