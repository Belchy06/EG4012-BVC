...
reverse_biorthogonal_decomposer::reverse_biorthogonal_decomposer(ovc::wavelet_config in_config)
{
	using namespace ovc;
...
ovc::wavelet_decomposition_2d<double> reverse_biorthogonal_decomposer::decompose(const matrix<double>& in_x, size_t in_num_levels)
{
