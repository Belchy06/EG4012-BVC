...
spiht_compressor::spiht_compressor()
{
	clear();
}

void spiht_compressor::compress(matrix<double> in_matrix, ovc::compression_config in_config)
{
...
void spiht_compressor::flush(uint8_t** out_bytes, uint16_t* out_step)
{
...
void spiht_compressor::get_successor(matrix<double>& in_matrix, size_t in_num_levels, int64_t in_x, int64_t in_y, int64_t* out_sx, int64_t* out_sy)
{
...
bool spiht_compressor::is_significant_pixel(matrix<double>& in_matrix, int64_t in_x, int64_t in_y, uint16_t in_step)
{
	return std::abs((int64_t)in_matrix(in_y, in_x)) >= (1 << in_step);
}

bool spiht_compressor::is_significant_set_A(matrix<double>& in_matrix, size_t in_num_levels, int64_t in_x, int64_t in_y, uint16_t in_step, int64_t in_count)
{
...
bool spiht_compressor::is_significant_set_B(matrix<double>& in_matrix, size_t in_num_levels, int64_t in_x, int64_t in_y, uint16_t in_step, int64_t in_count)
{
