...
typedef enum
{
	BVC_WAVELET_FAMILY_NONE,
	BVC_WAVELET_FAMILY_BIORTHOGONAL,
	BVC_WAVELET_FAMILY_COIFLETS,
	BVC_WAVELET_FAMILY_DAUBECHIES,
	BVC_WAVELET_FAMILY_HAAR,
	BVC_WAVELET_FAMILY_REVERSE_BIORTHOGONAL,
	BVC_WAVELET_FAMILY_SYMLETS
} bvc_wavelet_family;
